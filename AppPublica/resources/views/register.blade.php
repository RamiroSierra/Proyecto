...
<html lang="es">
  <head>
    ...
    <!--Necesario agregar clase theme para referenciarlo en js-->
    ...
    <div class="contenedor">
      <div class="contact-wrapper">
        ...
        <div class="contact-info">
          ...
          <br />
          <p>
            Y conviertete en miembro de la primer empresa uruguaya en
            visualizacion de resultados deportivos
          </p>
          <br />
          <ul>
            <li>
            ...
            <li>
              <a href="https://twitter.com/YzYSports" target="_blank"
